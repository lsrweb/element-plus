...
| size                                  | 输入框尺寸                                                                                                         | ^[enum]`'' \| 'large' \| 'medium' \| 'default' \| 'small'`                                                                                                                  | —                                              |
...
| 波普尔选项          | [popper.js](https://popper.js.org/docs/v2/) parameters                                                            | ^[object]refer to [popper.js](https://popper.js.org/docs/v2/) doc                                                                                                           | —                                  |
