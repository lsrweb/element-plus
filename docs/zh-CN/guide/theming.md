...
```html
<el-tag style="--elp-tag-bg-color: red">Tag</el-tag>
```
...
// 获取 css 变量
getComputedStyle(el).getPropertyValue(`--elp-color-primary`)

// 设置 css 变量
el.style.setProperty('--elp-color-primary', 'red')
```
