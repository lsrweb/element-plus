<template>
  ...
  >
    ...
    <g clip-path="url(#clip0_2477_1001)">
      ...
      <path d="M80 56H120V124H80V56Z" fill="var(--elp-fill-color-blank)" />
      <path
        d="M120 56H119.5V124H120H120.5V56H120Z"
        fill="var(--elp-color-info-light-5)"
        mask="url(#path-3-inside-1_2477_1001)"
      />
      <mask id="path-5-inside-2_2477_1001" fill="white">
        <path d="M120 56H160V124H120V56Z" />
      </mask>
      <path d="M120 56H160V124H120V56Z" fill="var(--elp-fill-color-blank)" />
      <path
      ...
      <rect
        ...
        height="4"
        rx="2"
        fill="var(--elp-color-primary-light-5)"
      />
      <rect
        x="172"
        y="70"
