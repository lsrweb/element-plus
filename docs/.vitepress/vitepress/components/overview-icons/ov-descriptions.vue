<template>
  ...
  >
    ...
    <rect
      ...
      height="4"
      rx="2"
      fill="var(--elp-border-color-dark)"
    />
    <rect
      x="71"
      y="110"
    ...
    <path
      ...
      fill="var(--elp-border-color-light)"
    />
    <rect
      x="146"
      y="63"
    ...
    <rect
      ...
      fill="var(--elp-border-color-dark)"
    />
    <path d="M65 90H215V102H65V90Z" fill="var(--elp-border-color-light)" />
    <rect
      x="71"
      y="95"
      width="12"
    ...
    <line
      ...
      x2="140.25"
      y2="90"
      stroke="var(--elp-border-color-light)"
      stroke-width="0.5"
    />
    <defs>
      <filter
